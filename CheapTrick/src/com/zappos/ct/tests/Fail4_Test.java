...
public class Fail4_Test extends SeleniumBase {
    ...
    public static void HomePageFail() {
        ...
        try {
            ...
            if (!helpLinks.equals("foo"))
            	System.out.println("Checkout Test" + "," + System.getProperty("ct.browser") + "," + "FAIL" + "," + stackTrace + "," + "/screenshots/1355361154529_HomePageTest.png");
        } 
